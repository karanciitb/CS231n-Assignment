...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        dx2, dW2, db2 = affine_relu_backward(softmax, relu2_cache)
    ...
    def loss(self, X, y=None):
        ...
        for i in range(self.num_layers - 1):
            ...
            x, cache = affine_norm_relu_forward(
                x, w, b, gamma, beta, bn_params, self.normalization, self.use_dropout, self.dropout_param)
            caches.append(cache)
...
def affine_norm_relu_forward(x, w, b, gamma, beta, bn_params, normalization, use_dropout, dropout_param):
...
def affine_norm_relu_backward(dout, cache, normalization, use_droput):
